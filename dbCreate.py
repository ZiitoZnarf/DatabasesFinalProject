...
def insert_sample_data(cursor):
    ...
    ''', [
        ...
        ('CL0048', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'XL', 'Independent', 35, 28.00, False, True,False),
        ('CL0049', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'S', 'Independent', 75, 28.00, True, False, False),
        ('CL0050', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'M', 'Independent', 43, 28.00, True, False,False),
        ('CL0051', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'L', 'Independent', 46, 28.00, True, False,False),
        ('CL0052', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'XL', 'Independent', 35, 28.00, True, False,False),
        ('CL0053', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'S', 'Independent', 67, 28.00, False, False, True),
        ('CL0054', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'M', 'Independent', 86, 28.00, False, False,True),
        ('CL0055', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'L', 'Independent', 32, 28.00, False, False,True),
        ('CL0056', 'Independent Spanning Chest', 'Shirt', 'Graphic Tee', 'XL', 'Independent', 35, 28.00, False, False,True),
